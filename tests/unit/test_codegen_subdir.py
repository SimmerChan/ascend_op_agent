...
def test_scaffold_inject_node_loads_12_files_parameterized(tmp_path, monkeypatch):
    """_scaffold_inject_node 从 load_build_scaffold 注入 5 构建 + 3 ST + 4 op_api 文件(子目录)。"""
